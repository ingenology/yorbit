...
<html>
    <head>
        <meta charset="utf-8">
        <title>Create and design your map | Yorbit</title>
...
<div class="container"> 
  <div class="application"> 
	<div id="containerDiv" class="containerDiv"> 
	  <div id="mapDiv" class="map-holder"></div>
	  <div id="messageDiv"><span id="messageSpan" class="messageSpan"></span></div>
	</div>
	<div class="tools"> 
	  <form action="GIBSmap.cfm?action=saveMap" method="post" id="form1" name="form1">
		...
		<div class="item type"> 
		  ...
		  <div class="content"> 
			...
			<div class="row4"> 
			  <textarea name="messageIn" id="messageIn" placeholder="Please type here to edit your text." onChange="$('#messageDiv').css('visibility','visible'); $('#messageSpan').text($('#messageIn').val()); $('#colorIn').val('#ffffff');"></textarea>
			  <div class="button" onclick="$('#messageDiv').css('visibility','visible'); $('#messageSpan').text($('#messageIn').val()); $('#colorIn').val('#ffffff');">Apply</div>
			</div>
		  </div>
		</div>
		<div class="item objects"> 
		  ...
		  <div class="content"> 
			<div class="row1"> 
			  <div class="square" onClick="$('#messageDiv').css({'visibility':'visible','background-color':'#000000'});$('#messageBackColor').val('#000000');"></div>
			  ...
			  <div class="buttons"> 
				<div onClick="$('#messageDiv').css('background-color','initial');" class="button delete" > 
				  Delete </div>
				<div> 
		...
		<div class="btn btn-primary btn-skinny pull-right" onClick="$('#form1').submit();">Save 
		  &amp; Publish</div>
		<!--
